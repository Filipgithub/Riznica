Ext.define("riznica.core.view.AbstractSearchView", {
                  ...
                  items: [
                    ...
                    },
                    {
                      ...
                      handler: function (config) {
                        ...
                        //debugger;
                        //
                        //console.log(this.up().up().down("#order").getStore());

                        // if (this.up().up().xtype == "search-order-OrderSearchView") {
                        // var orders = [];
                        // this.up().up().down("#order").getStore().each(function(record) {
                        //   orders.push(record.data.order);
                        //   //console.log("title: " + record.data.title);
                        // });

                        //criteria.orders = orders;
                        //console.log("order title: " + criteria.orders.title);
