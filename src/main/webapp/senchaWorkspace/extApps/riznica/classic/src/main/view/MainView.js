          ...
          items: [
            {
              ...
              items: [
                ...
                { xtype: 'core-view-TreeToolbarView', storeId: topLevelNavigationTreeStoreId, flex: 1, border: false, marignRight: "10px", style: 'background-color: transparent !important; '
                },
                {
                  xtype: 'container', layout: { type: 'hbox', align: 'right' }, style: 'margin: 5px 10px 5px 5px',
                  items: [
                    {
                      //adding new User
                      xtype: 'button', text: "Add new user", margin: "5 5 5 5", handler: "onClickAddUser",
                    },
                    {
                      xtype: 'toolbar',
            ...
            // {
            //   xtype: 'core-view-TreeToolbarView', storeId: topLevelNavigationTreeStoreId, border: false, flex: 1
            // },
          ]
        },
        {},
